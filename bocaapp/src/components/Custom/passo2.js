...
export function Passo2({ moveStep, customCart, setCustomCart, quantity, setQuantity }) {

    const flavorsList = [
        "Calabresa com catupiry", "Carne seca", "Bolinho de queijo", "Kibe",
        "Enroladinho de salsicha", "Carne", "Risole", "Frango"
    ];
    ...
    function selectFlavor(flavorName) {
        let selectedFlavors = customCart.flavors ? [...customCart.flavors] : [];
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 150, paddingHorizontal: 24, paddingTop: 24 }} className='flex-1 w-full'>
                <View className='flex-col w-full'>
                    <View className='w-full'>
                        <View className="w-full">
                            <Text className="text-[25px] font-montserrat-bold text-cinza text-center">Recheios</Text>
                            <Text className="text-[12px] font-montserrat-light mb-[10%] text-cinza text-center">Selecione até 3 sabores de recheio. Se escolher 3 sabores, o primeiro sabor selecionado será o que virá em maior quantidade.</Text>
                        ...
                        <View className="flex-row justify-between gap-20 w-full mb-[30%]">
